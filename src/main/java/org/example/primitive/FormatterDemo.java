...
public class FormatterDemo {
    public static void main(String[] args) {
        ...
        formatter = new Formatter();
        formatter.format("%+d", 111);   // + sign specifier
        System.out.println(formatter);
        ...
        formatter = new Formatter();
        formatter.format("%.15s", "12345678901234567890"); // Display at most 15 characters in a string.
        System.out.println("String notation to 15 places: " + formatter);

        formatter = new Formatter();
        formatter.format("%010d", 88); // Format into 10 digit
